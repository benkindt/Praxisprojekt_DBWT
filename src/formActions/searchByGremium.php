...
// 	$query = "SELECT * FROM person, gremiumsmitglied, gremium WHERE person.pid IN (SELECT DISTINCT person.pid FROM person, gremiumsmitglied, gremium WHERE gremium.gid = '" . $gremium . "') AND person.pid = gremiumsmitglied.pid ORDER BY person.pid;";
	$query = "SELECT DISTINCT ON (gremiumsmitglied.gmid) person.pid, person.vorname, person.nachname, gremiumsmitglied.gmid, gremium.name, gremiumsmitglied.nachruecker, gremiumsmitglied.von as gvon, gremiumsmitglied.bis as gbis, gremiumsmitglied.grund, wahlperiode.von as wvon, wahlperiode.bis as wbis, fachschaft.name as fname FROM person, gremiumsmitglied, gremium, fachschaft, fachschaftsmitglied, wahlperiode WHERE person.pid IN (SELECT DISTINCT person.pid FROM person, gremiumsmitglied, gremium, fachschaft, fachschaftsmitglied WHERE gremium.gid = '" . $gremium . "' AND gremiumsmitglied.gid = gremium.gid AND gremiumsmitglied.pid = person.pid) AND fachschaftsmitglied.fid = fachschaft.fid AND person.pid = fachschaftsmitglied.pid AND person.pid = gremiumsmitglied.pid AND gremium.gid = gremiumsmitglied.gid ORDER BY gremiumsmitglied.gmid;";
